    ...
    public void updateDatatable(final String datatableName, final JsonCommand command) {
        ...
        try {
            ...
            if (!StringUtils.isBlank(apptableName)) {
                ...
                final String oldApptableName = queryForApplicationTableName(datatableName);//check for associated table
                //if oldApptable,apptable's are different then go to change fk..
