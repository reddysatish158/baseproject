...
@Service
public class DeleteOwnedHardwareCommandHandler implements NewCommandSourceHandler {

	
	OwnedHardwareWritePlatformService ownedHardwareWritePlatformService;
	
	@Autowired
	public DeleteOwnedHardwareCommandHandler(final OwnedHardwareWritePlatformService ownedHardwareWritePlatformService) {
	...
	public CommandProcessingResult processCommand(JsonCommand command) {
		return ownedHardwareWritePlatformService.deleteOwnedHardware(command.entityId());
	}
