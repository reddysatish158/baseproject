...
import org.mifosplatform.logistics.itemdetails.mrn.service.MRNDetailsReadPlatformService;
...
public class MRNDetailsApiResource {
	...
	final private AgentReadPlatformService agentReadPlatformService;
	...
	public MRNDetailsApiResource(final PlatformSecurityContext context, final PortfolioCommandSourceWritePlatformService portfolioCommandSourceWritePlatformService
			...
			,final AgentReadPlatformService agentReadPlatformService) {
