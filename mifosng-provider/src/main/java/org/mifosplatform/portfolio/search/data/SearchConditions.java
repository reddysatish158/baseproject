...
public class SearchConditions {
    ...
    public SearchConditions(String searchQueryParam, String searchResource) {
        ...
        this.deviceSearch= (null == searchResource || searchResource.toLowerCase().contains(SEARCH_SUPPORTED_RESOURCES.DEVICES.name().toLowerCase()))? true : false;
    }
    public SearchConditions(String searchQueryParam, String searchResource, Boolean clientSearch, Boolean groupSearch, Boolean loanSeach, Boolean clientIdentifierSearch,Boolean deviceSearch) {
        this.searchQuery = searchQueryParam;
        this.searchResource = searchResource;
