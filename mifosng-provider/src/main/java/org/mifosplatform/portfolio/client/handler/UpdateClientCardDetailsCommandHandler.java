...
@Service
public class UpdateClientCardDetailsCommandHandler implements NewCommandSourceHandler {

	private final ClientCardDetailsWritePlatformService clientCardDetailsWritePlatformService;

    @Autowired
    public UpdateClientCardDetailsCommandHandler(ClientCardDetailsWritePlatformService clientCardDetailsWritePlatformService) {
	...
	public CommandProcessingResult processCommand(JsonCommand command) {
    	return this.clientCardDetailsWritePlatformService.updateClientCardDetails(command);
	}
