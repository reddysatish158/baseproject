...
public class IpGeneration {
     ...
     * @param ipPoolManagementReadPlatformService 
     * @throws IllegalArgumentException if the parameter is invalid,
     * i.e. does not match n.n.n.n/m where n=1-3 decimal digits, m = 1-3 decimal digits in range 1-32
     */
    public IpGeneration(String cidrNotation,IpPoolManagementReadPlatformService ipPoolManagementReadPlatformService) {
     ...
     */
    public IpGeneration(String address, String mask) {
    ...
    public final class SubnetInfo {
      ...
      /*  //addresses[j] = format(toArray(add));
    	...
    	String data=format(toArray(add));
    	if(data.equalsIgnoreCase("192.168.0.1")){
    		j=j-1;       		
    		System.out.println("skipped data is:"+data);
    		System.out.println("broadcast is:"+broadcast);
    		broadcast=broadcast+1;
    		System.out.println("broadcast is:"+broadcast);
    		System.out.println(j);
    	}else if(data.equalsIgnoreCase("192.168.0.3")){
    		j=j-1;       		
    		System.out.println("skipped data is:"+data);
    		System.out.println("broadcast is:"+broadcast);
    		broadcast=broadcast+1;
        ...
        public String toString() {
           ...
           /* buf.append("CIDR Signature:\t[").append(getCidrSignature()).append("]")
                ...
                .append("Broadcast:\t[").append(getBroadcastAddress()).append("]\n")
                 ...
                 String[] data=getAllAddresses();
       
               /* int j=0;
                for(int i=network;i<broadcast;i++){
                	j=j+1;
                	buf.append("data is :").append(format(toArray(low()))).append("]\n");
                }*/
                 buf.append("# Addresses:\t[").append(getAddressCount()).append("]\n");
            return buf.toString();
        }
    }
