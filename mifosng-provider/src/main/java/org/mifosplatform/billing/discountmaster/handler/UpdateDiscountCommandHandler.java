...
@Service
public class UpdateDiscountCommandHandler implements NewCommandSourceHandler {

    private final DiscountWritePlatformService writePlatformService;

    @Autowired
    public UpdateDiscountCommandHandler(final DiscountWritePlatformService writePlatformService) {
