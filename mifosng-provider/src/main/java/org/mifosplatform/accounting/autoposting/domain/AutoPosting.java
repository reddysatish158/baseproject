...
public class AutoPosting extends AbstractPersistable<Long> {
    ...
    private AutoPosting(Office office,   Code event, CodeValue eventAttribute, AccountingRule accountingRule, String name,
    ...
    public static AutoPosting fromJson(Office office,  Code event, CodeValue eventAttribute, AccountingRule accountingRule,
            JsonCommand command) {
        ...
        return new AutoPosting(office,  event, eventAttribute, accountingRule, name, description, productTypeEnum, productId);
    }
